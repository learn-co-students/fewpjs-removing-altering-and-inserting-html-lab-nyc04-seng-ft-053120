describe("index.html", () => {
  describe("after index.js is processed", () => {
    ...
    it("has a 'newHeader' variable that points to node 'h1#victory' with \"cool!\" inside", () => {
      expect(newHeader.innerHTML, "Make sure you create an <h1> with id 'victory' with a sweet message in it").to.include("cool!");
    });
